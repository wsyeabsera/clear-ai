...
exports.useThemeStyles = exports.useTheme = exports.ThemeProvider = void 0;
const jsx_runtime_1 = require("react/jsx-runtime");
const react_1 = require("react");
const configs_1 = require("./configs");
const ThemeContext = (0, react_1.createContext)(undefined);
const ThemeProvider = ({ children, defaultTheme = 'default', }) => {
    const [themeName, setThemeName] = (0, react_1.useState)(defaultTheme);
    const [theme, setThemeState] = (0, react_1.useState)(configs_1.themes[defaultTheme]);
    const setTheme = (newThemeName) => {
        setThemeName(newThemeName);
        setThemeState(configs_1.themes[newThemeName]);
        // Store theme preference in localStorage
        localStorage.setItem('theme-preference', newThemeName);
        // Apply theme to document root for global CSS variables
        applyThemeToDocument(configs_1.themes[newThemeName]);
    };
    ...
    (0, react_1.useEffect)(() => {
        ...
        if (savedTheme && configs_1.themes[savedTheme]) {
            setThemeName(savedTheme);
            setThemeState(configs_1.themes[savedTheme]);
            applyThemeToDocument(configs_1.themes[savedTheme]);
        }
        else {
            applyThemeToDocument(theme);
        }
    }, []);
    const availableThemes = Object.keys(configs_1.themes);
    const contextValue = {
        theme,
        themeName,
        setTheme,
